...
if (isset($_POST["update_customization"])) {
    ...
    if ($Validation) {
        ...
        if (isset($Validation["subscribers"])) {
            $c_subscriber = 1;
        } else {
            $c_subscriber = 0;
        }
        if (isset($Validation["featured"])) {
            $c_featured = 1;
        } else {
            $c_featured = 0;
        }
        if (isset($Validation["subscriptions"])) {
            $c_subscriptions = 1;
        } else {
            $c_subscriptions = 0;
        }
        if (isset($Validation["friends"])) {
            $c_friends = 1;
        } else {
            $c_friends = 0;
        }
        if (isset($Validation["videos"])) {
            $c_videos = 1;
        } else {
            $c_videos = 0;
        }
        if (isset($Validation["favorites"])) {
            $c_favorites = 1;
        } else {
            $c_favorites = 0;
        }
        if (isset($Validation["comments"])) {
            $c_comments = 1;
        } else {
            $c_comments = 0;
        }
        ...
        if (isset($Validation["featured_channels"])) {
            $Featured_Channels = 1;
        } else {
            $Featured_Channels = 0;
        }
        if (isset($Validation["recent"])) {
            $Recent_Activity = 1;
        } else {
            $Recent_Activity = 0;
        }
        if (isset($Validation["playlists"])) {
            $Playlists = 1;
        } else {
            $Playlists = 0;
        }
        ...
        notification("Your channel theme has successfully been updated!", "/channel_theme", "green");
        exit();
    }
}
