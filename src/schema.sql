...
('channels', '1'),
('guidelines', '<div class=\"vc_r\" style=\"margin-bottom:0\">\r\n  <h2 style=\"border-bottom: 1px solid #ccc; margin: 0 0 10px;\">About the VidLii Guidelines</h2>\r\n  <p>The VidLii Guidelines are meant to be easily comprehensible and straightforward. We strive to make them inclusive and accommodating to everyone. We request you to abide by our concise set of rules to ensure a safe and positive experience for everyone.</p>\r\n  <h2 style=\"border-bottom: 1px solid #ccc;\">The Rules</h2>\r\n  <ul class=\"cgul\" style=\"padding-left: 29px;\">\r\n    <li><b>Respect Others:</b> VidLii is a community of individuals with diverse opinions and backgrounds. We expect everyone to treat each other with respect and kindness. Any content that promotes hate speech, harassment, discrimination, or violence will not be tolerated on our platform.</li>\r\n    <li><b>Keep it Legal:</b> You must follow all applicable laws and regulations when using VidLii. Do not upload or share any content that violates copyright, trademark, or any other intellectual property laws. Also, do not share content that is illegal or violates any other laws.</li>\r\n    <li><b>No Nudity or Sexual Content:</b> VidLii is not a platform for pornography or sexually explicit content. Any content that contains nudity or sexual content will be removed from our platform.</li>\r\n    <li><b>No Spam:</b> We do not allow spam on our platform. Do not upload or share content that is intended to promote or sell illicit goods, products or services.</li>\r\n    <li><b>Age Restriction:</b> Users must be at least 13 years old to use VidLii. If you are under 18 years old, you must have the consent of a parent or legal guardian to use our platform.</li>\r\n    <li><b>Reporting:</b> If you come across any content that violates our guidelines or community standards, please report it immediately. We take all reports seriously and will take appropriate action.</li>\r\n    <li><b>Be Authentic:</b> We encourage you to be yourself on VidLii. Do not upload or share any content that is fake or misleading. You are responsible for the content you upload or share on our platform.</li>\r\n  </ul>\r\n<h2 style=\"border-bottom: 1px solid #ccc; margin: 22px 0 10px;\">We Enforce These Guidelines</h2>\r\n<p>Periodically, our staff at VidLii reviews flagged videos to ensure they adhere to our Community Guidelines. If we find any violation, we take necessary action to remove them. Any account found violating these guidelines will be penalized, and repeated or severe violations may lead to account termination. We urge you to follow these guidelines without trying to find any loopholes or attempting to circumvent them by any means.</p></div>'),
('help', '<strong>Q: Is VidLii a free service?</strong>\r\n\r\n<p>A: Yes, VidLii is completely free to use with no strings attached.</p>\r\n<strong>Q: How do I become a moderator on VidLii?\r\n</strong>A: You don\'t :)\r\n\r\n<strong>Q: How can I share a video on VidLii?</strong>\r\n\r\n<p>A: To share a video on VidLii, simply copy the embed code provided under the video description.</p>\r\n<strong>Q: What is the maximum video length allowed on VidLii?</strong>\r\n\r\n<p>A: Regular users can upload videos up to 25 minutes long, while partners can upload videos up to 35 minutes long.</p>\r\n<strong>Q: What file formats are accepted for video uploads on VidLii?</strong>\r\n\r\n<p>A: VidLii accepts video uploads in the following formats: .3GP, .AVI, .FLV, .MOV, .MP4, .MPEG, .MPG, .WEBM, and .WMV.</p>\r\n<strong>Q: What is VidLii\'s policy on copyright infringement?</strong>\r\n\r\n<p>A: VidLii respects the rights of copyright holders and publishers and only accepts video uploads from persons who hold all necessary rights to the uploaded material. VidLii\'s policy is to respond to any notices of alleged infringement that comply with the Digital Millennium Copyright Act (DMCA).</p>\r\n<strong>Q: Why do I keep getting asked to log in on VidLii?</strong>\r\n\r\n<p>A: If VidLii keeps asking you to log in, make sure you have cookies enabled on your browser.</p>\r\n<strong>Q: What are tags used for on VidLii?</strong>\r\n\r\n<p>A: Tags are basically keywords that describe your videos, making them easier to find by other users.</p>\r\n<strong>Q: How do I delete one of my videos on VidLii?</strong>\r\n\r\n<p>A: To delete a video on VidLii, simply go to the watch page of your video and click on the \"Delete Video\" button right under the video description. Alternatively, you can also go to the \"My Videos\" page and delete a video from there.</p>\r\n<strong>Q: What is the size limit for video uploads on VidLii?</strong>\r\n\r\n<p>A: The size limit for video uploads on VidLii is 2 GB per video, and each user is limited to a maximum of 8 video uploads per day.</p>\r\n<strong>Q: How can I report a video on VidLii?</strong>\r\n\r\n<p>A: To report a video on VidLii, click the \"Flag\" button below the video player and report the video for the rule that it\'s breaking.</p>'),
('login', '1'),
('logo', '3F9B'),
('settings', '0'),
('signup', '1'),
